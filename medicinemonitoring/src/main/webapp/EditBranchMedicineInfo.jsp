...
<title>EditBranchMedicineInfo</title>
...
<h1>Edit Medicine</h1>
<div class="formdata">
<form:form onsubmit="return validate()" action="updateBranchMedicine?userid=<%=userid%>&&medid=${editBranchMedicine.medicineId}" modelAttribute="editBranchMedicine" method="post">
<table>
<tr>
<td>Medicine Name:</td>
<td><form:input path="medicineName" id="medicineName" type="text"/></td>
</tr>
<tr>
<td>Treatment:</td>
