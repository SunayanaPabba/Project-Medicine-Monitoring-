...
<h1>Edit Stock</h1>
<div class="formdata">
<form:form onsubmit="return validate()" action="updateMedicine?id=${editMedicine.medicineId}" modelAttribute="editMedicine" method="post">
<table>
<tr>
<td>Medicine Name:</td>
...
<tr>
<td>Quantity</td>
<td><form:input path="quantity" type="text" id="quantity"/>
</tr>
</table>
