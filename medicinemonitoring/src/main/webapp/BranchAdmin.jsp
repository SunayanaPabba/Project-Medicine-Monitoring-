...
<tr>
<td>UserId:</td>
<td><form:input path="adminId" id="adminId" class="formcontrol"/></td>
</tr>
<tr>
<td>Password:</td>
<td><form:input path="password" id="password" type="password" class="formcontrol"/></td>
</tr>
<tr>
<td>Email:</td>
<td><form:input path="email" id="email" type="email" class="formcontrol"/></td>
</tr>
<tr>
<td>BranchId:</td>
<td><form:input path="branchId" id="branchId" class="formcontrol"/></td>
</tr>

<tr>
<td>BranchName:</td>
<td><form:input path="branchName" id="branchName" class="formcontrol"/></td>
</tr>
<tr>
<td>Address:</td>
<td><form:input path="address" id="address" class="formcontrol"/></td>
</tr>
<tr>
